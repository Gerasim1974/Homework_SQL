...
--Создайте ХП ChargeUser, которая принимает Email юзера и BookId, и будет обновлять колонку 
--ToCharge в соответствующей записи таблицы UserBooks, вызывая функцию для расчёта пени.
